#include <jni.h>
#include <string>
#include "com_example_wangxi_livedemo_jni_PushNative.h"
...
jobject jobj_push_native; //Global ref  只有jobject才可以作为global ref
...
JNIEXPORT void JNICALL Java_com_example_wangxi_livedemo_jni_PushNative_startPush
    ...
    rtmp_path = new char[strlen(url_cstr) + 1];
...
JNIEXPORT void JNICALL Java_com_example_wangxi_livedemo_jni_PushNative_stopPush
        (JNIEnv *env, jobject jobj) {
    is_pushing = FALSE;

}

JNIEXPORT void JNICALL Java_com_example_wangxi_livedemo_jni_PushNative_release
        (JNIEnv *env, jobject jobj) {
    env->DeleteGlobalRef(jobj_push_native);
}

JNIEXPORT void JNICALL Java_com_example_wangxi_livedemo_jni_PushNative_setVideoOptions
...
JNIEXPORT void JNICALL Java_com_example_wangxi_livedemo_jni_PushNative_setAudioOptions
...
JNIEXPORT void JNICALL Java_com_example_wangxi_livedemo_jni_PushNative_fireAudio
    ...
    pcmbuf = (int *) (short*) malloc(nInputSamples * sizeof(int));
